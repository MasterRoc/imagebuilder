...
EXTRA_PACKAGES="${EXTRA_PACKAGES:-luci luci-theme-argon luci-i18n-ddns-zh-cn luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn luci-i18n-package-manager-zh-cn kmod-sched-core kmod-sched-bpf kmod-veth kmod-xdp-sockets-diag curl nano}"
