...
EXTRA_PACKAGES="${EXTRA_PACKAGES:-luci luci-i18n-base-zh-cn openssh-sftp-server luci-i18n-ddns-zh-cn luci-i18n-ttyd-zh-cn luci-i18n-firewall-zh-cn luci-i18n-package-manager-zh-cn kmod-sched-core kmod-sched-bpf kmod-veth kmod-xdp-sockets-diag curl nano}"
...
- The selected ImmortalWrt 25.12.* ImageBuilder and package feeds are out of sync.
...
Next choices:
- Retry later with the same 25.12.* URL after ImmortalWrt feeds finish syncing.
